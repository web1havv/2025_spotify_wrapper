...
export function getCompanyRecommendations(topics, totalProblems) {
...
export function getTopCompanyMatch(topics, totalProblems) {
  const recommendations = getCompanyRecommendations(topics, totalProblems);
